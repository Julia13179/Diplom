# Чеклист для сдачи дипломного проекта
...
- [x] Покрытие кода 100%
- [x] Отчет coverage сгенерирован: `Task_1/htmlcov/index.html`
...
- [x] Allure отчет сгенерирован: `Task_2/allure-report/index.html`
...
- [x] Allure отчет сгенерирован: `Task_3/allure-report/index.html`
